...
import 'package:rideasy/AllScreens/searchScreen.dart';
import 'package:rideasy/Assistants/assistantMethods.dart';
import 'package:rideasy/Components/divider.dart';
import 'package:rideasy/Components/drawerWidget.dart';
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                ((tripDirectionDetails != null)
                                    ? 'Rs.${AssistantMethods.calculateFare(tripDirectionDetails)}'
                                    : ''),
                                style: TextStyle(
                                    fontSize: 16.0, color: Colors.black),
                              ),
